...
%Line to work with weather dataset
preDataset = load('weather2.data');       %Load the dataset

%Line to work with mushroom dataset
% preDataset = load('mushroom.csv');  preDataset = [preDataset(:, 2:end) preDataset(:,1)];
...
n =10;  %Set to ~10 for weather and to ~6600 for mushroom
%Divide dataset in:
